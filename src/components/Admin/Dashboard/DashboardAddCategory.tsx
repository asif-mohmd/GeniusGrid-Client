...
const DashboardAddCategory: React.FC<Props> = () => {
  ...
  return (
    <div className="flex justify-center mt-4 bg-gray-50">
      <ToastContainer />
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white rounded-lg shadow-lg p-8 mb-14">
        <div className="mb-3">
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="inline-flex  px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Add Category
          </button>
        </div>
