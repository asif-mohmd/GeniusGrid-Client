    ...
    <div className="px-3 py-4 flex justify-center">
        <table className="w-full text-md bg-white shadow-md rounded mb-4">
            <tbody>
                ...
                <tr className="border-b hover:bg-orange-100 bg-white">
                    <td className="p-3 px-5"><input type="text" value="user.name" className="bg-transparent"></input></td>
                    <td className="p-3 px-5"><input type="text" value="user.email" className="bg-transparent"></input></td>
