    ...
    <>
      <div className="flex flex-col md:flex-row justify-between px-6 md:px-12 lg:px-24 xl:px-32 mt-10">
        ...
        <div className="md:w-1/2 p-6 md:p-12 md:order-first"> {/* Order first on medium screens and up */}
          <h1 className="my-3 text-3xl md:text-4xl lg:text-4xl font-semibold font-poppins">Learning comes to you</h1>
          <p className="text-base md:text-lg lg:text-md font-poppins ">
            Sale ends today. Attain a world of knowledge at home or on the go.
          </p>
          <p className="text-base md:text-lg lg:text-sm font-poppins">Courses as low as $10</p>
        </div>
      </div>
    </>
  );
