...
import { ICreateCourse1 , ICreateCourse3} from "../../interfaces/IInstructorInterface";
...
export const {setCourseData1, setCourseData3} = createCourseData.actions;
